class CreateCivilActPayments < ActiveRecord::Migration[6.0]
  def change
    create_table :civil_act_payments do |t|
    ...
    add_index :civil_act_payments, :transaction_id, unique: true
    add_index :civil_act_payments, :payment_trnx_ref, unique: true
  end
end
