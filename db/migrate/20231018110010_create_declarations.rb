class CreateDeclarations < ActiveRecord::Migration[6.0]
    def change
      create_table :declarations do |t|
        ...
        t.string :nif_code
        t.string :liquidation_number
        t.string :quittance_number
        t.string :notify_at
      ...
      add_index :declarations, :quittance_number, unique: true
      add_index :declarations, :transaction_id, unique: true
      add_index :declarations, :ticket_number, unique: true
      add_index :declarations, :payment_trnx_ref, unique: true
    end
end